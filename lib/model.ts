...
type IModifierFunction = (obj: IObject, field: string | number, value: any) => void
interface ILastStepModifierFunctions {
  $set?: IModifierFunction
  $unset?: IModifierFunction
  $push?: IModifierFunction
  $pop?: IModifierFunction
  $pull?: IModifierFunction
  $addToSet?: IModifierFunction
  $inc?: IModifierFunction
  $max?: IModifierFunction
  $min?: IModifierFunction
}
interface IComparisonFunctions {
 ...
 */
function checkKey(k: string | number, v: any) {
  if (typeof k === 'number') {
    k = k.toString()
  }
 ...
 */
export function deepCopy(obj: any, strictKeys?: boolean) {
  let res: IObject | any[]

  if (typeof obj === 'boolean' || typeof obj === 'number' || typeof obj === 'string' || obj === null || _.isDate(obj)) {
    return obj
  }
 ...
 */
export function isPrimitiveType<T>(obj: T) {
  return (
    typeof obj === 'boolean' ||
    typeof obj === 'number' ||
    typeof obj === 'string' ||
 ...
 */
function compareNSB(a: number, b: number) {
  if (a < b) {
    return -1
  }
  if (a > b) {
...
export function compareThings(
  a: number | any[],
  b: number | any[],
  _compareStrings?: (a: number, b: number) => 0 | 1 | -1,
) {
  let aKeys: string[],
    bKeys: string[],
    comp: number,
  ...
  // Dates
  if (_.isDate(a)) {
    return _.isDate(b) ? compareNSB(a.getTime(), b.getTime()) : -1
  }
  if (_.isDate(b)) {
    return _.isDate(a) ? compareNSB(a.getTime(), b.getTime()) : 1
  }
 ...
 */
lastStepModifierFunctions.$set = function(obj: IObject, field: string | number, value: any) {
  obj[field] = value
}
 ...
 * Unset a field
 */
lastStepModifierFunctions.$unset = function(obj: IObject, field: string | number, value: any) {
  delete obj[field]
}
 ...
 */
lastStepModifierFunctions.$push = function(
  obj: { [x: string]: any[] },
  field: string | number,
  value: { $slice?: any; $each?: any },
) {
 ...
 */
lastStepModifierFunctions.$addToSet = function(obj: IObject, field: string | number, value: any) {
  let addToSet = true
  ...
  if (value !== null && typeof value === 'object' && value.$each) {
    ...
    obj[field].forEach(function(v: any) {
 ...
 */
lastStepModifierFunctions.$pop = function(obj: IObject, field: string | number, value: string | number) {
  if (!Array.isArray(obj[field])) {
 ...
 */
lastStepModifierFunctions.$pull = function(obj: IObject, field: string | number, value: any) {
  let arr: { [x: string]: any; length: number; splice: (arg0: any, arg1: number) => void }, i: number
 ...
 */
lastStepModifierFunctions.$inc = function(obj: IObject, field: string, value: string) {
  if (typeof value !== 'number') {
 ...
 */
lastStepModifierFunctions.$max = function(obj: IObject, field: string | number, value: number) {
 ...
 */
lastStepModifierFunctions.$min = function(obj: IObject, field: string | number, value: number) {
  if (typeof obj[field] === 'undefined') {
    obj[field] = value
  } else if (value < obj[field]) {
    obj[field] = value
...
function createModifierFunction(modifier: string) {
  return function(obj: IObject, field: any, value: any) {
 ...
 */
export function modify(obj: { _id: any }, updateQuery: { [x: string]: IObject; _id?: any }) {
  ...
  if (dollarFirstChars.length === 0) {
    ...
    newDoc = deepCopy(obj)
    modifiers.forEach(function(m: string) {
      let keys: string[]
 ...
 */
export function areThingsEqual(a: { [x: string]: any; getTime?: any }, b: { [x: string]: any; getTime?: any }) {
  let aKeys: string[], bKeys: string[], i: number
 ...
 */
function areComparable(a: any, b: any) {
  if (
    typeof a !== 'string' &&
    typeof a !== 'number' &&
    !_.isDate(a) &&
 ...
 */
comparisonFunctions.$lt = (a: any, b: any) => areComparable(a, b) && a < b

comparisonFunctions.$lte = (a: any, b: any) => areComparable(a, b) && a <= b

comparisonFunctions.$gt = (a: any, b: any) => areComparable(a, b) && a > b

comparisonFunctions.$gte = (a: any, b: any) => areComparable(a, b) && a >= b

comparisonFunctions.$ne = (a: any, b: any) => {
  if (a === undefined) {
    return true
  }
...
comparisonFunctions.$in = (a: any, b: any) => {
  let i: number
...
comparisonFunctions.$nin = (a: any, b: any) => {
  if (!Array.isArray(b)) {
...
comparisonFunctions.$regex = (a: string, b: any) => {
  if (!_.isRegExp(b)) {
...
comparisonFunctions.$exists = (value: any, exists: any) => {
  if (exists || exists === '') {
...
// Specific to arrays
comparisonFunctions.$size = (obj: any, value: any) => {
  if (!Array.isArray(obj)) {
    return false
  }
  if (value % 1 !== 0) {
...
comparisonFunctions.$elemMatch = (obj: any, value: any) => {
  if (!Array.isArray(obj)) {
    return false
  }
  let i = obj.length
 ...
 * @param {Query} query
 */
logicalOperators.$not = function(obj: any, query: any) {
